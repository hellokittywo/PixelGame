...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(TimerInfo)),
        _GT(typeof(SpringPanel)),

        _GT(typeof(LuaFramework.GameManager)),
        ...
        _GT(typeof(TweenProperty)),
        _GT(typeof(TweenPosition)),
        _GT(typeof(TweenScale)),
        _GT(typeof(TweenColor)),
        _GT(typeof(TweenAlpha)),
        _GT(typeof(TweenRotation)),
        _GT(typeof(LuaToCSFunction)),
	    _GT(typeof(GameStart)),
        _GT(typeof(MouseClick)),
        _GT(typeof(MyDragAndDrop)),
        _GT(typeof(SequenceAnimation)),
        _GT(typeof(UIDragClick)),
    };
