...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CompressFileFastZip", CompressFileFastZip);
		L.RegFunction("DecompressFileFastZip", DecompressFileFastZip);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CompressFileFastZip(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			LuaFramework.Util.CompressFileFastZip(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DecompressFileFastZip(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			LuaFramework.Util.DecompressFileFastZip(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
