...
public class UI2DSpriteWrap
{
	...
	static int get_nextSprite(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index nextSprite on a nil value");
		}
	}
	...
	static int get_sprite2D(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index sprite2D on a nil value");
		}
	}
